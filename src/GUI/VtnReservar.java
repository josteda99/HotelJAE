 ...
 * @author Asus-PC
 */
public class VtnReservar extends javax.swing.JFrame {

    /**
     * Creates new form VtnReservar
     */
    public VtnReservar() {
        initComponents();
        //comboBoxRegistro(VentanaAdministrador.);
    }

    private void comboBoxRegistro(ArrayList<Habitacion> hotel,JComboBox cbxNHabitacion){
        for(int i =0 ; i< 11 ; i++){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VtnReservar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VtnReservar().setVisible(true);
            }
        });
    }
